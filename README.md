...
<p align="center">
  <strong>QGIS 样式管理与批量应用插件</strong><br>
  支持正则匹配图层名称，自动应用 QML 样式
</p>
...
<table>
  <tr>
    ...
    <td align="center"><b>样式规则配置</b></td>
  </tr>
  <tr>
    <td><img src="docs/images/main.jpg" alt="主界面" width="300"></td>
    <td><img src="docs/images/style_rule.jpg" alt="样式规则配置" width="450"></td>
  </tr>
</table>
...
│   └── ⚙️ layer_processor.py # 图层遍历与样式应用
├── 📂 ui/
│   ├── 📄 panel_widget.py  # 主对话框界面
│   └── 📄 edit_dialog.py   # 编辑对话框界面
